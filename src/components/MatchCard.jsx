...
const MatchCard = ({ match, onAccept, onReject, onClick }) => {
  ...
  return (
    <motion.div
      ...
      className="card relative group cursor-pointer hover:shadow-xl transition-shadow active:scale-[0.98] duration-200"
    >
      {/* Compatibility Badge */}
      <motion.div 
      ...
      <motion.div 
        ...
        className="aspect-[4/5] bg-slate-200 relative overflow-hidden"
      >
        {profile.image_url ? (
      ...
      <div className="p-6 space-y-6">
        ...
        <div>
          <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-3">Spiritual Core</h4>
        ...
        {/* Action Buttons - Use stopPropagation to avoid triggering card expansion */}
